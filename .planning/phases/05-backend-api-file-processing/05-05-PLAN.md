...
<task type="auto">
  ...
  <action>
    ...
    1. **Import** ResultsOutput from @epub-counter/shared
  ...
  <verify>grep -q "validateResultsOutput\|ValidationResult" server/src/lib/schema-validator.ts</verify>
  <done>Schema validator exists with validateResultsOutput function</done>
</task>
...
<task type="auto">
  ...
  <action>
    ...
    1. **Import** dependencies:
     - ResultsOutput from @epub-counter/shared
