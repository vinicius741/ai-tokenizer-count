...
3. Update root package.json scripts:
   ...
   - Add "dev:ui" as alias to "dev:web" (for development convenience)
   - NOTE: Combined "dev" script running both web and server will be added in 04-04 after server exists
...
cat package.json | grep '"concurrently"'
  ...
  <done>
Frontend dependencies installed, root has dev:web script and concurrently installed
  </done>
</task>
